...
public static class GTUtility
{
    ...
    // Token: 0x06000007 RID: 7 RVA: 0x00002518 File Offset: 0x00000718
    ...
    public static string GetFPS(VRRig rig)
    {
        ...
        {
            PlayerFPS playerFPS = rig.GetComponent<PlayerFPS>() ?? rig.gameObject.AddComponent<PlayerFPS>();
            result = playerFPS.CurrentFPS.ToString();
        }
        return result;
    }
